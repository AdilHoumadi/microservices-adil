package com.microservices.adil.kafka.consumer.config;

import com.microservices.adil.config.KafkaConfigData;
import com.microservices.adil.config.KafkaConsumerConfigData;
...
@EnableKafka
@Configuration
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecord> {
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<K, V>> kafkaListenerContainerFactory() {
        ...
        factory.setBatchListener(kafkaConsumerConfigData.isAutoStartup());
