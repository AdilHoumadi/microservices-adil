package com.microservices.adil.kafka.to.elastic.service.transformer;
    ...
    public List<TwitterIndexModel> getElasticModels(List<TwitterAvroModel> avroModels) {
        return avroModels.stream().map(
                avroModel -> TwitterIndexModel.builder()
                        ...
                        .createAt(LocalDateTime.ofInstant(Instant.ofEpochMilli(avroModel.getCreatedAt()), ZoneId.systemDefault()))
                        .build()
